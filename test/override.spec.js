  ...
  ["yaml", "json"].forEach((type) => {
    context(type, () => {
      ...
      it("should simply be the the app locales", function () {
        ...
        assert.strictEqual(
          resStore.en.main.sub.subsub.slugslug,
          "app sub.subsub.slugsub en"
        );
      ...
      it("should merge app over any libraries", function () {
        ...
        assert.strictEqual(
          resStore.en.main.sub.subsub.test,
          "lib sub.subsub.test en"
        );
        ...
        assert.strictEqual(
          resStore["zh-cn"].main.sub.test,
          "lib sub.test zh-cn"
        );
        assert.strictEqual(
          resStore["zh-cn"].main.sub.subsub.test,
          "lib sub.subsub.test zh-cn"
        );
        assert.strictEqual(
          resStore["zh-cn"].main.sub.slug,
          "app sub.slug zh-cn"
        );
        assert.strictEqual(
          resStore["zh-cn"].main.sub.subsub.slugslug,
